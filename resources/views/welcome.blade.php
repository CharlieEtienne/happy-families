...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="print:hidden navbar bg-neutral text-neutral-content sticky top-0 z-[60]">
        ...
        <footer class="print:hidden footer items-center p-4 bg-neutral text-neutral-content">
            <div class="items-center grid-flow-col">
                ...
                <p class="ml-2">Charlie Etienne © {{date('Y')}} - Absolutely no right reserved</p>
            </div>
