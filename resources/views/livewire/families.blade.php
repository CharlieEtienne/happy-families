    ...
    <div x-data="app" id="alpine-main-data">
        ...
        <div class="drawer lg:drawer-open lg:auto-cols-auto">
            ...
            <div class="print:w-full drawer-content flex flex-col items-center justify-center w-[97vw] lg:w-[calc(100vw-26rem)]">
                ...
                <div class="print:hidden topbar flex py-2 flex-col items-center w-full sticky bg-gray-100 z-50 top-[64px] box-gradient-shadow-custom">
                    ...
                    <button @click="window.print()" class="btn btn-primary fixed z-10 bottom-0 right-0 m-10 py-2 px-4 rounded-full shadow-xl text-white">
